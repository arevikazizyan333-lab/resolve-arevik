...
let TicketsController = class TicketsController {
    ...
    create(body, actor = 'api') {
        return this.ticketsService.create(actor, body);
    }
    ...
    changeStatus(id, body, actor = 'api') {
        return this.ticketsService.changeStatus(actor, id, body?.to);
    }
    addComment(id, body, actor = 'api') {
...
__decorate([
    ...
    __param(1, (0, common_1.Headers)('x-actor')),
...
__decorate([
    ...
    __param(2, (0, common_1.Headers)('x-actor')),
    __metadata("design:type", Function),
